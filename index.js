...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285281968399:+62 852-8196-8399\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const config = {
    A187: '👾MY BOT👾',
    instagram: 'https://instagram.com/amirrehan211',
    nomer: 'wa.me/6285281968399',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/Zobin Oficial',
    whatsapp: 'https://chat.whatsapp.com/JX3axLwCbrA3P9NxxvbQsn',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] NGENTOT SAYANG EHH SCAN SAYANG`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ANDIKA`)
})
